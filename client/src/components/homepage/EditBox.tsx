...
const readFile = (file: File): PromiseLike<ArrayBuffer | any> =>
	new Promise((resolve) => {
...
const EditBox: React.FC<Props> = (props) => {
	...
	const handleDownloadClick = (): void => {
		if (showCustomText) {
			if (primaryText === "Your Hacker Name")
				window.alert(
					"Please enter your hacker name!"
				)
			else if (secondaryText === "Your Guild Name")
				window.alert(
					"Please enter your Guild name"
				)
			else if (!uploadImage)
