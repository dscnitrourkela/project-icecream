...
const Item: React.FC<Props> = (props) => {
	const { uploadImage, crop, zoom, aspect, setCrop, setZoom, frame, bgcolor } = props;

	const classes = useStyles();
	return (
		<Card style={{backgroundImage: `${bgcolor.type}-gradient(to right, ${bgcolor.color1} , ${bgcolor.color2})`}} className={classes.root}>
			<div
